...
{% if cookiecutter.project_type == 'library' %}[<img alt="crates.io" src="https://img.shields.io/crates/v/{{cookiecutter.project_name}}.svg?style=for-the-badge&color=fc8d62&logo=rust" height="22">](https://crates.io/crates/{{cookiecutter.project_name}}){% endif %}
